variable "ssh_key" {
  description = "your public ssh key. If left unset (null/empty string), a new SSH key pair is generated automatically and its public key is used."
  type        = string
  default     = null
  nullable    = true
}
...
variable "ssh_private_key_output_path" {
  description = "path where the auto-generated SSH private key is written when var.ssh_key is not provided. Defaults to id_rsa inside this module's directory."
  type        = string
  default     = null
  nullable    = true
}
