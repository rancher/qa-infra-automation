...
2. Inventory Generated: You must have the `terraform-inventory.yml` file in the repository root (generated via `envsubst` in the quickstart guide for `aws/modules/cluster_nodes`).
