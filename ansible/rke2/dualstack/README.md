...
```bash
ansible-playbook -i ansible/rke2/default/inventory/inventory.yml ansible/rke2/dualstack/playbooks/rke2-playbook-dualstack.yml
```
...
The inventory file is generated automatically by `make infra-up` at `ansible/rke2/dualstack/inventory/inventory.yml`.
